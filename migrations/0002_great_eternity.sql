...
ALTER TABLE "borrow_records" ADD CONSTRAINT "borrow_records_book_id_book_id_fk" FOREIGN KEY ("book_id") REFERENCES "public"."book"("id") ON DELETE no action ON UPDATE no action;